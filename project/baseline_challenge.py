...
class BaselineChallenge(FlowSpec):
    ...
    def baseline(self):
        ...
        majority_class = self.traindf['label'].mode().iloc[0]
        predictions = np.array([majority_class] * self.valdf.shape[0])
